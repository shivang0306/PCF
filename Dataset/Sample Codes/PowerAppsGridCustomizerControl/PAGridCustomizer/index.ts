...
export class SampleDataSet implements ComponentFramework.ReactControl<IInputs, IOutputs> {
    /**
     * Empty constructor.
     */
    constructor() { 
    ...
    public init(
        ...
        if (this._eventName ) {
            ...
            const powerAppsProps: PowerAppsProps = { cellRendererOverrides: cellRendererOverrides(pcfContextService), cellEditorOverrides };
